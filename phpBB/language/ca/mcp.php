...
$lang = array_merge($lang, array(
	...
	'ADD_FEEDBACK_EXPLAIN'	=> 'Si voleu afegir un informe sobre això, ompliu el formulari següent. Useu només text net; no es permet l’HTML ni el BBCode.',
	'ADD_WARNING'			=> 'Afegeix un advertiment',
	'ADD_WARNING_EXPLAIN'	=> 'Per enviar un advertiment a aquest usuari, ompiu el formulari següent. Useu només text net; no es permet l’HTML ni el BBCode.',
	...
	'MERGE_TOPIC_EXPLAIN'	=> 'Podeu moure les entrades seleccionades a un altre tema usant el formulari següent. Les entrades es separaran d’aquest tema i es combinaran amb l’altre. Aquestes entrades no es reordenaran i apareixeran com si els usuaris les haguesin escrit al tema destí.<br />Introduïu l’id del tema destí o feu clic sobre “Selecciona un tema” per buscar-lo.',
	...
	'REPORT_MESSAGE_EXPLAIN'	=> 'Useu aquest formulari per informar del missatge privat seleccionat. És recomanable que només informeu dels missatges que incompleixen les normes del fòrum. <strong>Informar d’un missatge privat fa visible el seu contingut per tots els moderadors.</strong>',
	'REPORT_NOTIFY'				=> 'Avisa’m',
	'REPORT_NOTIFY_EXPLAIN'		=> 'Se us avisarà quan el vostre informe sigui gestionat.',
	'REPORT_POST_EXPLAIN'		=> 'Useu aquest formulari per informar de l’entrada seleccionada als moderadors i els administradors del fòrum. És recomanable que només informeu de les entrades que incompleixen les normes del fòrum.',
	...
	'report_reasons'		=> array(
		...
		'DESCRIPTION' => array(
			...
			'OTHER'		=> 'El missatge no encaixa en cap de les altres categories, si us plau useu el camp d’informació addicional.',
		),
	),
));
