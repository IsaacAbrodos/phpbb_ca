...
$help = array(
	...
	array(
		...
		1 => 'El BBCode admet diverses maneres diferents de crear enllaços.<ul><li>La primera utilitza l’etiqueta <strong>[url=][/url]</strong>, qualsevol cosa que escrigueu despres del signe = farà que el contingut de l’etiqueta es tracti com un URL. Per exemple, per enllaçar amb phpBB.com podeu utilitzar:<br /><br /><strong>[url=https://www.phpbb.com/]</strong>Visiteu el lloc web del phpBB!<strong>[/url]</strong><br /><br />Això es convertirà en l’enllaç següent, <a href="https://www.phpbb.com/">Visiteu el lloc web del phpBB!</a> Tingueu en compte que l’enllaç s’obrirà en la mateixa finestra o bé en una finestra nova depenent de la configuració del navegador de l’usuari.</li><li>Si voleu que el propi URL es mostri en el text de l’enllaç, simplement utilitzeu:<br /><br /><strong>[url]</strong>https://www.phpbb.com/<strong>[/url]</strong><br /><br />que es convertirà en l’enllaç següent, <a href="https://www.phpbb.com/">https://www.phpbb.com/</a></li><li>A més, el phpBB us proporciona una funció anomenada <i>Enllaços Màgics</i>, que convertirà qualsevol URL sintàcticament correcte en un enllaç sense que us calgui especificar ni les etiquetes ni el prefix https://. Per exemple, si escriviu www.phpbb.com en un missatge, automàticament es convertirà en <a href="https://www.phpbb.com/">www.phpbb.com</a> quan el visualitzeu.</li><li>El mateix passa amb les adreces de correu electrònic, podeu especificar l’adreça explicitament:<br /><br /><strong>[email]</strong>ningu@domini.adr<strong>[/email]</strong><br /><br />la qual cosa es convertirà en <a href="mailto:ningu@domini.adr">ningu@domini.adr</a> o bé simplement escriviu ningu@domini.adr dintre del vostre missatge i es farà la conversió automàticament quan el visualitzeu.</li></ul>De la mateixa manera que les altres etiquetes del BBCode, podeu posar un enllaç dintre d’altres etiquetes com ara <strong>[img][/img]</strong> (vegeu l’entrada següent), <strong>[b][/b]</strong>, etc. Igual que amb les etiquetes de formatació, cal que respecteu l’ordre en què s’obren i es tanquen, per exemple:<br /><br /><strong>[url=https://www.phpbb.com/][img]</strong>https://www.phpbb.com/theme/images/logos/blue/160x52.png<strong>[/url][/img]</strong><br /><br /><span style="text-decoration: underline">no</span> és correcte la qual cosa podria provocar que l’entrada sigui eliminada.'
	),
	array(
		0 => '--',
