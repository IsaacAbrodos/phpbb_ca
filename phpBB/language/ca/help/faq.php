...
$lang = array_merge($lang, array(
	'HELP_FAQ_ATTACHMENTS_ALLOWED_ANSWER'	=> 'L’administrador de cada fòrum pot permetre o no determinats tipus de fitxers adjunts. Si no esteu segur de què es permet penjar, contacteu amb l’administrador del fòrum.',
	...
	'HELP_FAQ_FORMATTING_HTML_ANSWER'	=> 'No. No és possible publicar HTML en aquest fòrum per que es mostri com a tal. La major part del formatat que es pot fer amb l’HTML el podeu aplicar usant el BBCode.',
	...
	'HELP_FAQ_GROUPS_USERGROUPS_LEAD_ANSWER'	=> 'Habitualment, el líder l’assigna l’administrador del fòrum quan crea el grup d’usuaris. Si esteu interessats a crear un grup d’usuaris, proveu de contactar amb l’administrador del fòrum enviant-li un missatge privat.',
	...
	'HELP_FAQ_ISSUES_ADMIN_QUESTION'	=> 'Com puc contactar amb l’administrador del fòrum?',
	...
	'HELP_FAQ_ISSUES_LEGAL_ANSWER'	=> 'Qualsevols dels administradors de la llista que pareix a la pàgina “L’equip” serà un contacte apropiat per a les vostres queixes. Si tot i així no rebeu cap resposta, és recomanable que contacteu amb el propietari del domini (feu una <a href="http://www.google.com/search?q=whois">cerca whois</a>) o, si el fòrum s’executa sobre un servei gratuït (p.ex. Yahoo!, free.fr, f2s.com, etc.), la direcció o el departament d’abús del servei en questió. Tingueu en compte que el phpBB Group <strong>no té absolutament cap jurisdicció</strong> i no pot ser fet responsable de com, on i qui usa aquest fòrum. No contacteu amb el phpBB Group en relació a qualsevol tema legal (cessar i desistir, responsabilització, comentaris difamatoris, etc.) <strong>no relacionat directament</strong> amb el lloc web phpBB.com o el programari phpBB en sí mateix. Si envieu un correu electrònic al phpBB Group <strong>sobre l’ús per part de tercers</strong> d’aquest programari espereu-vos una resposta succinta o, fins i tot, cap resposta.',
	'HELP_FAQ_ISSUES_LEGAL_QUESTION'	=> 'Amb qui he de contactar per tractar temes legals o d’abús relacionats amb aquest fòrum?',
	...
	'HELP_FAQ_LOGIN_CANNOT_LOGIN_ANSWER'	=> 'Pot passar per diverses raons. Primer, assegureu-vos que el vostre nom d’usuari i contrasenya són correctes. Si ho són, contacteu amb un administrador del fòrum per assegurar-vos que no us han expulsat. També és possible que l’administrador del fòrum tingui un error de configuració que hagi d’arreglar.',
	...
	'HELP_FAQ_PMS_CANNOT_SEND_ANSWER'	=> 'Hi ha tres raons possibles: no esteu registrat i amb la sessió iniciada, l’administrador del fòrum ha inhabilitat la missatgeria privada o no permet al vostre usuari enviar missatges. Contacteu amb l’administrador del fòrum per obtenir més informació.',
	...
	'HELP_FAQ_PMS_UNWANTED_ANSWER'	=> 'Podeu eliminar automàticamen missatges d’un usuari concret usant les regles de missatges del Tauler de control de l’usuari. Si rebeu missatges privats insultants per part d’un usuari en particular, informeu dels missatges als moderadors ja que poden inhabilitar l’enviament de missatges per part de l’usuari.',
	...
	'HELP_FAQ_SEARCH_NO_RESULT_ANSWER'	=> 'És probable que la cerca sigui massa vaga i inclogui moltes paraules comunes que el phpBB no indexa. Sigueu més específic i useu les opcions disponibles a la cerca avançada.',
	'HELP_FAQ_SEARCH_NO_RESULT_QUESTION'	=> 'Per què la cerca no troba cap coincidència?',
	'HELP_FAQ_SEARCH_OWN_ANSWER'	=> 'Podeu recuperar les vostres entrades o bé fent clic a l’enllaç “Mostra les meves entrades” del Tauler de control de l’usuari o bé l’enllaç “Cerca les entrades d’aquest usuari” del vostre perfil o fent clic al menú “Enllaços ràpids” a la part de dalt del fòrum. Per cercar els vostres temes, useu la pàgina de cerca avançada introduïnt les opcions apropiades.',
