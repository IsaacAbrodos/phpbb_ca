...
$lang = array_merge($lang, array(
	...
	'QUESTIONS'					=> 'Preguntes',
	'QUESTIONS_EXPLAIN'			=> 'Cada cop que es trameti un formulari on hagueu habilitat el connector de Preguntes i respostes, es farà als usuaris una de les preguntes especificades aquí. Per utilitzar aquest connector cal que definiu com a mínim una pregunta en l’idioma per defecte. Aquestes preguntes haurien de ser fàcils per a l’audiència del vostre fòrum però més enllà de la capacitat d’un robot capaç de realitzar una cerca a Google™. Només cal una única pregunta. Si comenceu a rebre registres automatitzats d’usuaris, haurieu de canviar la pregunta. Habiliteu la comprovació estricta si les vostres preguntes depenen de les majúscules, les minúscules, els signes de puntuació o els espais en blanc.',
