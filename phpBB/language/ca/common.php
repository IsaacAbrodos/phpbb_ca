...
$lang = array_merge($lang, array(
	...
	'BOARD_BAN_PERM'		=> 'Se us ha suspès <strong>permanentment</strong> en aquest fòrum.<br /><br />Si us plau, contacteu amb l’%2$sadministrador del fòrum%3$s per obtenir més informació.',
	'BOARD_BAN_REASON'		=> 'Raó de la suspensió: <strong>%s</strong>',
	'BOARD_BAN_TIME'		=> 'Se us ha suspès en aquest fòrum fins el <strong>%1$s</strong>.<br /><br />Si us plau, contacteu amb l’%2$sadministrador del fòrum%3$s per obtenir més informació.',
	...
	'COOKIE_CONSENT_MSG'	=> 'Aquest lloc web usa galetes per fer que hi teniu la millor experiència possible.',
	...
	'FTP_FSOCK_HOST_EXPLAIN'		=> 'Servidor FTP usat per connectar-vos al vostre lloc web.',
	'FTP_FSOCK_PASSWORD'			=> 'Contrasenya FTP',
	'FTP_FSOCK_PASSWORD_EXPLAIN'	=> 'Contrasenya del vostre usuari FTP.',
	'FTP_FSOCK_PORT'				=> 'Port FTP',
	'FTP_FSOCK_PORT_EXPLAIN'		=> 'Port usat per connectar-vos al servidor.',
	...
	'FTP_HOST_EXPLAIN'			=> 'Servidor FTP usat per connectar-vos al vostre lloc web.',
	'FTP_PASSWORD'				=> 'Contrasenya FTP',
	'FTP_PASSWORD_EXPLAIN'		=> 'Contrasenya del vostre usuari FTP.',
	'FTP_PORT'					=> 'Port FTP',
	'FTP_PORT_EXPLAIN'			=> 'Port usat per connectar-vos al servidor.',
	...
	'LOGIN_ERROR_PASSWORD'				=> 'Heu especificat una contrasenya incorrecta. Si us plau comproveu la vostra contrasenya i intenteu-ho una altra vegada. Si continueu tenint problemes, contacteu amb l’%sadministrador del fòrum%s.',
	'LOGIN_ERROR_PASSWORD_CONVERT'		=> 'No s’ha pogut convertir la vostra contrasenya durant l’actualització d’aquest fòrum. Si us plau %sdemaneu una nova contrasenya%s. Si continueu tenint problemes, contacteu amb l’%sadministrador del fòrum%s.',
	'LOGIN_ERROR_USERNAME'				=> 'Heu especificat un nom d’usuari incorrecte. Si us plau comproveu el vostre nom d’usuari i intenteu-ho una altra vegada. Si continueu tenint problemes, contacteu amb l’%sadministrador del fòrum%s.',
	...
	'SQL_ERROR_OCCURRED'		=> 'S’ha produït un error SQL durant l’obtenció d’aquesta pàgina. Si us plau, contacteu amb l’%sadministrador del fòrum%s si aquest problema continua.',
