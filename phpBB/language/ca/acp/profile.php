...
$lang = array_merge($lang, array(
	...
	'STEP_3_EXPLAIN_CREATE'			=> 'Com que teniu més d’un dioma instal·lat al fòrum, també heu d’omplir els elements d’idioma restants. Si no ho feu, s’utilitzarà l’idioma per defecte per aquest camp presonalitzat del prefil, també podeu omplir els elements d’idioma restants més tard.',
	'STEP_3_EXPLAIN_EDIT'			=> 'Com que teniu més d’un dioma instal·lat al fòrum, podeu canviar o afegir els elements d’idioma restants. Si no ho feu, s’utilitzarà l’idioma per defecte per aquest camp presonalitzat del prefil.',
