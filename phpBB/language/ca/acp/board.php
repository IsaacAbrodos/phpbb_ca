...
$lang = array_merge($lang, array(
	...
	'DEFAULT_DATE_FORMAT_EXPLAIN'	=> 'La sintaxi usa el mateix format que les <a href="https://www.php.net/manual/datetime.format.php">funcions de data</a> del PHP.',
	...
	'SYSTEM_TIMEZONE_EXPLAIN'		=> 'Fus horari usat per mostrar hores als usuaris que no han iniciat sessió (visitants, robots). Els usuaris que han iniciat sessió decideixen el seu fus horari durant el procediment de registre i poden canviar-lo al Tauler de control de l’usuari.',
	'WARNINGS_EXPIRE'				=> 'Durada dels advertiments',
	'WARNINGS_EXPIRE_EXPLAIN'		=> 'Nombre de dies que han de passar abans que un advertiment venci automàticament del registre d’un usuari. Useu el valor 0 per fer que els advertiments siguin permanents.',
));
...
$lang = array_merge($lang, array(
	...
	'HOT_THRESHOLD_EXPLAIN'			=> 'Llindar d’entrades per tema necessàries per que un tema es consideri popular. Useu un 0 per inhabilitar els temes populars.',
...
//	'ACC_USER_ADMIN'			=> 'User + Admin',
	...
	'USERNAME_CHARS_EXPLAIN'	=> 'Restringeix el tipus de caràcters que poden ser usats als noms d’usuari, els caràcters d’espaiat són: l’espai, -, +, _, [ i ].',
...
$lang = array_merge($lang, array(
	...
	'CAPTCHA_GD_EXPLAIN'					=> 'Usa la llibreria gràfica GD per fer una imatge més avançada contra els robots de brossa.',
	'CAPTCHA_GD_FOREGROUND_NOISE_EXPLAIN'	=> 'Usa soroll en primer pla per fer que la imatge sigui més difícil de llegir.',
	'CAPTCHA_GD_X_GRID'						=> 'Soroll de fons segons l’eix x',
	'CAPTCHA_GD_X_GRID_EXPLAIN'				=> 'Useu valors baixos per fer que la imatge sigui més difícil de llegir. Un 0 inhabilita el soroll de fons segons l’eix x.',
	'CAPTCHA_GD_Y_GRID'						=> 'Soroll de fons segons l’eix y',
	'CAPTCHA_GD_Y_GRID_EXPLAIN'				=> 'Useu valors baixos per fer que la imatge sigui més difícil de llegir. Un 0 inhabilita el soroll de fons segons l’eix y.',
	...
	'CAPTCHA_GD_FONTS'						=> 'Usa fonts diferents',
	'CAPTCHA_GD_FONTS_EXPLAIN'				=> 'Aquesta configuració controla quantes formes diferents de lletres s’usen. Podeu usar les formes per defecte o introduir lletres modificades. També és possible afegir lletres minúscules.',
	'CAPTCHA_FONT_DEFAULT'					=> 'Per defecte',
	'CAPTCHA_FONT_NEW'						=> 'Formes noves',
	'CAPTCHA_FONT_LOWER'					=> 'Usa també les minúscules',
	'CAPTCHA_NO_GD'							=> 'Imatge simple',
	'CAPTCHA_PREVIEW_MSG'					=> 'Els canvis que heu fet no s’han desat, això és només una previsualització.',
	'CAPTCHA_PREVIEW_EXPLAIN'				=> 'Aquest és l’aspecte que tindrà el connector si useu la configuració actual.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_CDN'						=> 'Permet l’ús de xarxes de distribució de continguts externes',
	'ALLOW_CDN_EXPLAIN'				=> 'Si habiliteu aquesta configuració, alguns fitxers se serviran des de servidors externs en lloc del vostre servidor. Això redueix l’ample de banda usat pel vostre servidor, però pot ser un problema de privacitat en alguns països. En una instal·lació per defecte del phpBB això inclou carregar “jQuery” i la font “Open Sans” des de la xarxa de distribució de continguts de Google. Això també aplica a la font “Font Awesome”, que el phpBB i algunes extensions usen per dibuixar icones.',
	...
	'LIMIT_LOAD_EXPLAIN'			=> 'Si la càrrega del sistema per a 1 minut sobrepassa aquest valor, el fòrum quedarà automàticament fora de línia. El valor 1.0 equival a un ús aproximat del 100% d’un processador. Això només funciona en servidors basats en UNIX i on aquesta informació estigui accessible. Aquest valor es reinicialitza automàticament a 0 si el phpBB no es capaç d’obtenir el límit de càrrega.',
...
$lang = array_merge($lang, array(
	...
	'LDAP_SERVER_EXPLAIN'			=> 'Si useu LDAP aquest es el nom de l’amfitrió o l’adreça IP del servidor LDAP. Alternativament, podeu especificar un URL de l’estil ldap://hostname:port/',
	...
	'LDAP_USER_EXPLAIN'				=> 'Deixeu-lo buit per usar la vinculació anònima. Si l’introduïu, el phpBB usa el distinguished name en els intents d’inici de sessió per trobar l’usuari correcte, p.ex. <samp>uid=Usuari,ou=Unitat,o=Companyia,c=ES</samp>. És necessari per a servidors Active Directory.',
...
// Server Settings
$lang = array_merge($lang, array(
	'ACP_SERVER_SETTINGS_EXPLAIN'	=> 'Aquí podeu definir configuracions que depenen del servidor i del domini. Assegureu-vos que les dades que introduïu són correctes, si hi ha errors els correus electrònics que s’enviïn des del fòrum contindran informació incorrecta. Quan introduïu el nom de domini recordeu-vos d’incloure http:// o el protocol adequat. Modifiqueu el número de port només si sabeu que el servidor usa un valor diferent, el port 80 és correcte en la majoria de casos.',
	...
	'MOD_REWRITE_DISABLED'		=> 'El mòdul <strong>mod_rewrite</strong> del vostre servidor Apache està inhabilitat. Habiliteu el módul o contacteu amb el vostre proveïdor d’allotjament web si voleu habilitar aquesta funció.',
	...
	'SERVER_PROTOCOL_EXPLAIN'	=> 'S’usa com a protocol del servidor si es força aquesta configuració. Si és buit o no es força la configuració, el protocol es determina per la configuració de galeta segura (<samp>http://</samp> o <samp>https://</samp>).',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_PASSWORD_RESET_EXPLAIN'	=> 'Determina si els usuaris poden usar l’enllaç “He oblidat la meva contrasenya” de la pàgina d’inici de sessió per recuperar el seu compte. Si useu un sistema d’autenticació extern, és possible que vulgueu inhabilitar aquesta funció.',
	...
	'FORM_TIME_MAX_EXPLAIN'			=> 'El temps que te un usuari per trametre un formulari. Useu un -1 per inhabilitar-ho. Tingueu en compte que un formulari pot esdevenir no vàlid si venç la sessió, sense tenir en compte aquesta configuració.',
	...
	'REFERRER_VALID_EXPLAIN'		=> 'Si l’habiliteu, es comprovarà la pàgina des de la qual es fan les sol·licituds POST segons la configuració d’amfitrió/camí. Això pot donar problemes amb fòrums que usin diversos dominis i/o un inici de sessió extern.',
...
$lang = array_merge($lang, array(
	...
	'SMTP_AUTH_METHOD_EXPLAIN'		=> 'Només s’usa si s’ha introduït un nom d’usuari i contrasenya, pregunteu al vostre proveïdor si no esteu segur de quin mètode usar.',
	...
	'SMTP_PORT_EXPLAIN'				=> 'Canvieu-lo només si sabeu que el servidor SMTP usa un port diferent.',
	...
	'SMTP_VERIFY_PEER_EXPLAIN'		=> 'Requereix la verificació del certificat SSL usat pel servidor SMTP.<em><strong>Advertiment:</strong> Connectar-se a servidors amb un certificat SSL no verificat pot tenir implicacions de seguretat.</em>',
	'SMTP_VERIFY_PEER_NAME'			=> 'Verifica el nom del servidor SMTP',
	'SMTP_VERIFY_PEER_NAME_EXPLAIN'	=> 'Requereix la verificació del nom dels servidors SMTP que usen connexions SSL / TLS.<em><strong>Advertiment:</strong> Connectar-se a servidors amb nom no verificat pot tenir implicacions de seguretat.</em>',
	...
	'USE_SMTP'						=> 'Usa el servidor SMTP per al correu electrònic',
...
$lang = array_merge($lang, array(
	...
	'JAB_USE_SSL'					=> 'Usa SSL per connectar-te',
	...
	'JAB_VERIFY_PEER_EXPLAIN'		=> 'Requereix la verificació del certificat SSL usat pel servidor Jabber.<em><strong>Advertiment:</strong> Connectar-se a servidors amb un certificat SSL no verificat pot tenir implicacions de seguretat.</em>',
	'JAB_VERIFY_PEER_NAME'			=> 'Verifica el nom del servidor Jabber',
	'JAB_VERIFY_PEER_NAME_EXPLAIN'	=> 'Requereix la verificació del nom dels servidors Jabber que usen connexions SSL / TLS.<em><strong>Advertiment:</strong> Connectar-se a servidors amb nom no verificat pot tenir implicacions de seguretat.</em>',
));
